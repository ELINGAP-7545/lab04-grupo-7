...
2. Cree el nuevo proyecto VERILOG QUARTUS para Visualizaci髇 Dinamica 4 Display, tomando como base los archivos dados.
3.Creer el archivo testbench.v
4.Genera la simulaci髇, Revise que el sistema funciona como usted lo esperaba. Realice lo comentarios necesarios en el archivo README.md.
5.Modificar o A馻dir los bloques necesarios para que la visualizaci髇 sea en representaci髇 Decimal y no Hexadecimal.
